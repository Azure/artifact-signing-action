...
1. Assign the [Artifact Signing Certificate Profile Signer](https://learn.microsoft.com/en-us/azure/artifact-signing/concept-resources-roles#supported-roles) role to your service principal.
   ...
   1. Select 'Artifact Signing Certificate Profile Signer'.
   1. Next.
